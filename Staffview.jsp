<%-- 
    Document   : Staffview
    Created on : Jan 28, 2019, 12:24:36 PM
    Author     : STUDENTS
--%>
...
<html>
    ...
    <body>
        ...
        <tr><td>Staff ID</td><td>First Name</td><td>Last Name</td><td>Email</td><td>Mobile</td></tr>
        <%
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            String s="jdbc:sqlserver://localhost;databaseName=schooldb;user=sa;password=password123";
            Connection con=DriverManager.getConnection(s);
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select * from staff order by staffid");
            while(rs.next()){
        %> 
        <tr>
