<%-- 
    Document   : Staffbookreturn
    Created on : Jan 28, 2019, 11:41:00 AM
    Author     : STUDENTS
--%>
...
<html>
    ...
    <body>
        <%
            String bname="",aname="",sname="",rtdt="",stid="";
            
            DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
            
            ResultSet rs=(ResultSet)request.getAttribute("res");
            if(rs!=null){
                stid=rs.getString("staffid");
       ...
       <table>
        <tr>   
        <td><label for="sid" class="lab">Staff Id</label></td>
        <td><input type="text" class="txtbox" placeholder="" name="sid" id="sid" required="" value="<%=stid%>" >
